...
/*========================================== */
//Задача-1
let atribute = document.querySelector('[data-say-hi]');
let atribute1 = atribute.getAttribute('data-say-hi');
console.log(atribute1);
/*========================================== */
//Задача-2
...
/*========================================== */
//Задача-3
let list1 = document.querySelectorAll('.like');
let likeList = list1;
console.log(likeList);
/*========================================== */
//Задача-4
const list3 = document.querySelectorAll('ul');
...
console.log(video_1);
let video_1_top = video_1.offsetTop;
let video_1_left = video_1.offsetLeft;
console.log(video_1_top,video_1_left);

let like = document.querySelector('.like');
console.log(like);
let like_left = like.offsetLeft;
let like_top = like.offsetTop;
console.log(like_left,like_top)

let video_4 = document.querySelector('.video-4');
console.log(video_4);
let video_4_left = video_4.offsetLeft;
let video_4_top = video_4.offsetTop;
console.log(video_4_left,video_4_top)
